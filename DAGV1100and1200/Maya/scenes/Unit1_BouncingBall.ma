...
createNode camera -s -n "topShape" -p "top";
	rename -uid "9BCFDB0C-47E5-1FC8-4AAF-03B205DB5822";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "front";
	rename -uid "BD72902A-4022-ED0B-A97E-E6944BA8F52E";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0 1000.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "4B38AD59-4CF3-6B83-679B-D98C87FB2E83";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "side";
	rename -uid "BD5E1D00-4599-89A3-643B-90B25CA7EA67";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 0 0 ;
	setAttr ".r" -type "double3" 0 90 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "ADE3DAD0-4812-A3DE-5140-5298D5CD3AFB";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -n "Ball";
	rename -uid "AAAD6D4B-41AC-6815-8EAA-2BAEF700F4CD";
createNode mesh -n "BallShape" -p "Ball";
	rename -uid "E576F1D3-4E67-01EB-727B-CABCC2C951C0";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "E917C154-45C3-9620-AB95-A3BFB0BAE3D8";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "CCCE7442-4FEF-059C-4C46-11814DB8E7D5";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "BE569020-4D6D-036F-F380-2CAC365E098F";
createNode displayLayerManager -n "layerManager";
	rename -uid "893CE5D7-4222-24BA-5A1B-168E60954A1F";
createNode displayLayer -n "defaultLayer";
	rename -uid "115CDE70-4E15-2EB1-724E-2F9CBE061E10";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "44987D53-4DB1-335E-E0D7-4B82E22A7844";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "5BC54B59-4DEC-6B43-96C8-FD900599DE54";
	setAttr ".g" yes;
createNode script -n "uiConfigurationScriptNode";
	rename -uid "40078731-4D0D-D222-7135-11B4AC94CC5E";
