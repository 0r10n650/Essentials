...
//Name: Floor.ma
//Last modified: Thu, Jul 02, 2026 01:46:11 PM
//Codeset: 1252
requires maya "2027";
...
fileInfo "UUID" "94FB9AB5-4D3C-C8B0-1068-85A69CB85E91";
...
createNode mesh -n "FloorShape" -p "Floor";
	...
	setAttr ".pv" -type "double2" 0.45564732510034389 0.32207870977404329 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr -s 14 ".uvst[0].uvsp[0:13]" -type "float2" 0.33567885 0.010367885
		 0.66374797 0.010415807 0.33567685 0.024037287 0.663746 0.024085268 0.3356289 0.35210341
		 0.66369802 0.35215139 0.33562693 0.36577278 0.66369599 0.36582077 0.33557892 0.69383889
		 0.66364807 0.69388682 0.99181408 0.010463789 0.99181193 0.02413322 0.007612763 0.010319874
		 0.007610796 0.023989365;
...
createNode transform -s -n "persp";
	rename -uid "16EEC911-46C4-400C-1C34-D983A527ECAB";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.84365852467496971 22.690836818135022 34.318974071815418 ;
	setAttr ".r" -type "double3" -36.938352729604354 1.8000000000000347 9.94414021248305e-17 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "C3F72350-428A-5D65-BAD6-67A7AC4D5E81";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 41.457453445121466;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".hc" -type "string" "viewSet -p %camera";
createNode transform -s -n "top";
	rename -uid "0A3897B9-4715-FF63-0EE3-FA8ABCD4408F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 1000.1 0 ;
	setAttr ".r" -type "double3" -90 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "DFCB8EF5-428A-672F-2734-099BB4EBF185";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "front";
	rename -uid "5BE4F629-4DC5-0858-E8E6-C8941FFC6BFB";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0 1000.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "8772BAEB-452B-2752-4D6C-3E8D3AEDE67E";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "side";
	rename -uid "B413DECC-4899-E26A-DEA3-3D81BC8F3F46";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 0 0 ;
	setAttr ".r" -type "double3" 0 90 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "9E5ECAD5-4897-C38B-D243-BF9FAF8E7B75";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode displayLayerManager -n "layerManager";
	rename -uid "8E1F53A2-4680-FBD3-0E81-F7AC69A0ACE0";
	setAttr ".cdl" 2;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "E925017F-4C26-1374-17F6-B9AB4D6B436F";
	setAttr -s 4 ".lnk";
	setAttr -s 4 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "7C46B00A-4E1E-6EC1-ED40-27BA584F4153";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "30552EB8-4064-2ED2-BB3F-C58AFC5B0AB1";
createNode displayLayer -n "defaultLayer";
	rename -uid "37FFEF0D-4C06-A856-505E-ECB980C7A007";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "0D1D52EC-431B-7798-1A1B-F2A94655E285";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "E673AE93-452C-5862-D780-AF9802F42E1A";
	setAttr ".g" yes;
createNode shadingEngine -n "lambert1SG";
	rename -uid "5D1CD7C1-49B4-4CD1-DCB8-C7A5E7169E7F";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo1";
	rename -uid "F464F8B8-421D-4EAF-8EC9-E2A884288CFC";
createNode script -n "uiConfigurationScriptNode";
	rename -uid "7E2E1097-46AC-ABE9-A9FA-A4BC3D6F911A";
...
createNode script -n "sceneConfigurationScriptNode";
	rename -uid "AB272219-4DD3-832F-5BF7-A7AEE004B1A9";
	setAttr ".b" -type "string" "playbackOptions -min 1 -max 120 -ast 1 -aet 200 ";
	setAttr ".st" 6;
createNode lambert -n "lambert2";
	rename -uid "2A74228E-4CFD-578B-E4F7-D9B973B7CCBC";
createNode shadingEngine -n "lambert2SG";
	rename -uid "44A7A05A-498B-A7E4-81FF-62B9C947CBEA";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo2";
	rename -uid "3C875377-43C2-2407-478C-F095141D97EF";
createNode checker -n "checker1";
	rename -uid "0C649E28-44D8-C4D0-33FC-0C9AA5385A6D";
createNode place2dTexture -n "place2dTexture1";
	rename -uid "01437002-4835-4351-0894-5A84541B367A";
