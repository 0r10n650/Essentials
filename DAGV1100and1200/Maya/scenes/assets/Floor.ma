...
//Name: Floor.ma
//Last modified: Thu, Jun 25, 2026 02:51:00 PM
//Codeset: 1252
requires maya "2027";
requires "mtoa" "5.6.0";
...
fileInfo "UUID" "D1559740-49D8-697D-6AB2-16A4513F3AB7";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 27.181878221880179 21.220296813896631 28.484844826576964 ;
	setAttr ".r" -type "double3" -28.53835272960244 40.599999999999895 -2.0944783839044181e-15 ;
...
createNode displayLayerManager -n "layerManager";
	rename -uid "B7683919-4D34-5B74-8A98-BEA42646BF2A";
	setAttr ".cdl" 2;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "B2286A6B-433F-0687-42F1-478CFEAE3B15";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "26A0D14F-4A8B-B3D7-FE55-079607A653AE";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "A037C7FC-4664-9C96-BBB1-0899C57E9504";
createNode displayLayer -n "defaultLayer";
	rename -uid "37FFEF0D-4C06-A856-505E-ECB980C7A007";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "A7648A75-4271-73FA-3B0E-50B3E3257FD3";
