...
//Last modified: Mon, May 18, 2026 04:22:02 PM
//Codeset: 1252
requires maya "2027";
...
fileInfo "UUID" "E180436D-4FA2-3587-E808-0EB729707916";
createNode transform -s -n "persp";
	rename -uid "1DFBA4A4-134A-59AA-2739-3C93ABFFD067";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 35.182162711779412 28.370006385973351 55.868326276065957 ;
	setAttr ".r" -type "double3" -17.738352729601097 32.200000000001211 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "8426FD61-B94B-9F60-1746-D0BED0796422";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 69.318702574598802;
...
createNode transform -n "Arm";
	...
	setAttr ".rpt" -type "double3" 8.8817841970012523e-15 -1.1723955140041653e-13 0 ;
...
createNode transform -n "Elbow" -p "Arm";
	...
	setAttr ".rpt" -type "double3" 8.8817841970012523e-16 -3.7525538232330291e-14 0 ;
...
createNode transform -n "Hand" -p "Elbow";
	...
	setAttr ".rpt" -type "double3" 1.7763568394002505e-15 -8.8817841970012523e-14 0 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "2E6B6F7D-4108-80A2-AC4E-AF82765A2573";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "F1588020-40E7-F180-4ECC-47876AE76BF9";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "A34552AF-4454-91D5-F6E7-778988F38A68";
createNode displayLayerManager -n "layerManager";
	rename -uid "21344C99-4706-B401-C4AF-43B990628BAF";
createNode displayLayer -n "defaultLayer";
	rename -uid "138E985A-7348-29D9-3700-8797FCF8ABC7";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "E3B79B02-49FD-0EE9-0253-068F68AC88FC";
...
createNode animCurveTA -n "Arm_rotateZ";
	rename -uid "470685DB-41F3-8151-27C6-E9AB778C400D";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
...
createNode animCurveTA -n "Elbow_rotateZ";
	rename -uid "42E9319C-4D7D-5253-BF8E-C2BE9A99F0FA";
	setAttr ".tan" 1;
	setAttr ".wgt" no;
	...
	setAttr -s 5 ".kix[2:4]"  0.36575124839920486 0.19949172107156166 
		1;
	setAttr -s 5 ".kiy[2:4]"  -0.93071264324410208 0.97989951179899382 
		0;
	setAttr -s 5 ".kox[2:4]"  0.36575124046711538 0.19949170242017886 
		1;
	setAttr -s 5 ".koy[2:4]"  -0.93071264636125284 0.97989951559611399 
		0;
createNode animCurveTA -n "Hand_rotateZ";
	rename -uid "4EC79156-4615-FA80-B0BE-958E9036DEB4";
	setAttr ".tan" 1;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 50 7 100 13 -50 19 -100 25 50;
	setAttr -s 5 ".kix[0:4]"  0.11137329547125234 0.17452843573473542 
		0.10074409626352143 0.20695132929180679 0.11560665487747088;
	setAttr -s 5 ".kiy[0:4]"  0.99377864187950482 -0.98465213406562346 
		-0.99491237155241286 0.97835123923075507 0.99329507264862704;
	setAttr -s 5 ".kox[0:4]"  0.11137331208528074 0.1745284829985608 
		0.10074421290340603 0.2069513135912438 0.11560678241032842;
	setAttr -s 5 ".koy[0:4]"  0.99377864001756189 -0.98465212568816463 
		-0.9949123597415368 0.9783512425519062 0.99329505780544936;
select -ne :time1;
	setAttr ".o" 13;
	setAttr ".unw" 13;
